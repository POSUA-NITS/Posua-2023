        ...
        <section className={styles.borhomthuri}>
            ...
            <div className={styles.maincasette}>
                <div className={styles.casettereell} >
                    ...
                    <a href="https://drive.google.com/file/d/1j2WOPZXNL31CqiUylghfRh8jQObq2NDq/view?usp=share_link" target="_blank"className={`${styles.pdf3} ${styles.pdfs}`}></a>
                    <a href="https://docs.google.com/document/d/1KuPgoUgvejM5vVWe8TjMumhewcKzEWsQfOd14WPBto0/edit?usp=share_link" target="_blank" className={`${styles.pdf4} ${styles.pdfs}`}></a>
