  ...
  return (
    <>
      <div className={winWidth > 800 ? Styles.hero : Styles.hero_mobile}>
        {/* <img loading="lazy" placeholder={placeholder} src="/assets/Hero/sky.webp" alt="" className={Styles.sky} /> */}
        <img loading="lazy" placeholder={placeholder}
          src="https://res.cloudinary.com/dp92qug2f/image/upload/v1677766625/posua/Untitled_Artwork-1_Compressed_jylpz7.webp"
          alt=""
          className={Styles.sky}
        />
        {/* <img loading="lazy" placeholder={placeholder} src="/assets/Hero/clouds.webp" alt="" className={Styles.clouds} /> */}
        <img loading="lazy" placeholder={placeholder}
        ...
        />
        {/* <div className={Styles.posua}> */}
        {/* <img loading="lazy" placeholder={placeholder} src="/assets/Hero/posua.webp" alt="" className={Styles.posua} /> */}
        <img loading="lazy" placeholder={placeholder}
        ...
        {/* </div> */}
        {/* <img loading="lazy" placeholder={placeholder} src="/assets/Hero/hills.webp" alt="" className={Styles.hills} /> */}
        <img loading="lazy" placeholder={placeholder}
        ...
        {/* <img loading="lazy" placeholder={placeholder} src="/assets/Hero/pines.webp" alt="" className={Styles.pines} /> */}
        <img loading="lazy" placeholder={placeholder}
        ...
        />
        {/* <img loading="lazy" placeholder={placeholder} src="/assets/Hero/whitish-bush.webp" alt="" className={Styles.whitishBush} /> */}
        <img loading="lazy" placeholder={placeholder}
        ...
        />
        {/* <img loading="lazy" placeholder={placeholder} src="/assets/Hero/layer4.webp" alt="" className={Styles.layer4} /> */}
        <img loading="lazy" placeholder={placeholder}
          src="https://res.cloudinary.com/dp92qug2f/image/upload/v1677768835/posua/layer4-min.png_jztyxr.webp"
          alt=""
          className={Styles.layer4}
        />
        {/* <img loading="lazy" placeholder={placeholder} src="/assets/Hero/layer3.webp" alt="" className={Styles.layer3} /> */}
        <img loading="lazy" placeholder={placeholder}
          src="https://res.cloudinary.com/dp92qug2f/image/upload/v1677768890/posua/layer3-min.png_mq22bj.webp"
          alt=""
          className={Styles.layer3}
        />
        {/* <img loading="lazy" placeholder={placeholder} src="/assets/Hero/layer2.webp" alt="" className={Styles.layer2} /> */}
        <img loading="lazy" placeholder={placeholder}
          src="https://res.cloudinary.com/dp92qug2f/image/upload/v1677768946/posua/layer2-min.png_w8sruq.webp"
          alt=""
          className={Styles.layer2}
        />
        {/* <img loading="lazy" placeholder={placeholder} src="/assets/Hero/layer1.webp" alt="" className={Styles.layer1} /> */}
        <img loading="lazy" placeholder={placeholder}
          src="https://res.cloudinary.com/dp92qug2f/image/upload/v1677768991/posua/layer1-min.png_zu6lyb.webp"
          alt=""
          className={Styles.layer1}
        />
        {/* <img loading="lazy" placeholder={placeholder} src="/assets/Hero/bush.webp" alt="" className={Styles.bushInverted} /> */}
      </div>
      <div
