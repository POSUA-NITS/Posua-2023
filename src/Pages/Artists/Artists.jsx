        ...
        <>
            <div className={style.artists}>
                <div className={style.artistsmain}>
                    <div className={style.animateposua} >
                        <div className={style.redbg} >
                            <img src="https://res.cloudinary.com/dp92qug2f/image/upload/v1677100739/posua/rd_bg_duat4m.png" alt="" />
                        </div>

                        <div className={style.gmcha} >
                            <img src="https://res.cloudinary.com/dp92qug2f/image/upload/v1677128222/posua/gmcha_nobg_fqin50.png" alt="" />
                        </div>

                        <div className={style.tabla} >
                            <img src="https://res.cloudinary.com/dp92qug2f/image/upload/v1677128053/posua/tabla-nobg_my9jwi.png" alt="" />
                        </div>

                        <div className={style.flute} >
                            <img src="https://res.cloudinary.com/dp92qug2f/image/upload/v1677128156/posua/flute-nobg_mggx4t.png" alt="" /> </div>
                    </div>
                    <div className={style.titleholderartist} > <h1 className={style.artismainh1}>UPCOMING ARTISTS</h1></div>
                        ...
                        return (
                            <>
                                <div className={style.indicard}>
                                    ...
                                    <div className={style.artistwork}><h3>Singer</h3></div>
                                </div>
                            </>
                        )
                    })}
                ...
                <div className={style.flowerholder} >
                    <img className={style.leftflower} src="https://res.cloudinary.com/dp92qug2f/image/upload/v1677096323/posua/flowers-posua-removebg-preview_qjehkd12_nqdt2z.png" alt="" />
                    <img className={style.rightflower} src="https://res.cloudinary.com/dp92qug2f/image/upload/v1677096323/posua/flowers-posua-removebg-preview_qjehkd12_nqdt2z.png" alt="" />
                </div>
                ...
                <div className={style.artistsmain}>
                    ...
                    <div className={style.titleholderartist} > <h1 className={style.artismainh1}>PREVIOUS ARTISTS</h1></div>
